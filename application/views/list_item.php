                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($items_data as $item_row) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="<?php echo base_url('item/edit/' . $item_row->item_hashval); ?>"><i class="dripicons-pencil"></i></a></td>
                                                            <td><a  href="#" ><i onclick="delete_item(<?php echo $item_row->item_id; ?>)" class="dripicons-trash"></i></a></td>
                                                        </tr>
                                                    <?php } ?>
