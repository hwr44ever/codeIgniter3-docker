                                        ...
                                        <form class="needs-validation" novalidate id="add_user_form" method="POST">
                                            <div class="form-row">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="company_name" placeholder="Enter Company Name Here"  required>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" class="form-control" id="validationCustomUsername" placeholder="Email Address" aria-describedby="inputGroupPrepend" required>
                                            ...
                                            <br>
                                            <button class="btn btn-primary" type="button" id="submit_button" name="submit_button">Add Vendor</button>
                                        </form>
            ...
            $(document).ready(function () {
                ...
                $("#submit_button").click(function (event) {
                    ...
                    if (company_name == '') {
                        ...
                        $.ajax({
                            //alert(email);
                            url: "<?php echo base_url() . 'vendor/vendor_added'; ?>",
                            data: {"company_name": company_name, "first_name": first_name, "last_name": last_name, "contact": contact_phone, "email": email, "address": address},
                            type: "POST",
