    ...
    <body>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($users_data as $user_row) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="<?php echo base_url('user/edit/' . $user_row->user_hashval); ?>"><i class="dripicons-pencil"></i></a>
        ...
        <script>
                                                                function delete_item(id) {
                                                                    Swal.fire({
                                                                        title: 'Are you sure? You want User to be deactivate?<br>(کیا واقعی  آپ اس صارف کو غیر فعال کرنا چاھتے ہیں ؟)',
