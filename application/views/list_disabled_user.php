                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($users_data as $user_row) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="<?php echo base_url('user/edit/' . $user_row->user_id); ?>"><i class="dripicons-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a  href="#" ><img src="<?php echo base_url(SITETHEME . 'myImages/good.png'); ?>" onclick="delete_item(<?php echo $user_row->user_id; ?>)"></a></td>
