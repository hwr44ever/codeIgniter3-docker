                                        ...
                                        <form  id="add_entry_form" action="<?php echo base_url('cash/add_entry'); ?>" method="POST">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="hidden" class="form-control"  id="invoice_hashval" name="invoice_hashval" value="<?php echo $invoice_data->invoice_hashval; ?>"  required>
                                                    <input type="date" class="form-control" onblur="checkInvoice()" id="date" name="date" value="<?php echo $invoice_data->date; ?>"  required>
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control" onblur="checkInvoice()" id="vendor_drop_down" name="vendor_drop_down">
                                                            ...
                                                            foreach ($vendor_data as $vendor_row) {
                                                                if ($invoice_data->vendor_id != $vendor_row->vendor_id) {                                                                   
                                                                    ?>
                                                                    <option <?= $vendor_value ?> value="<?php echo $vendor_row->vendor_id; ?>"><?php echo $vendor_row->vendor_company; ?></option>
                                                                    <?php                                                                    
                                                                }else{
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" onblur="checkInvoice()" id="weight_qty" value="<?php echo $invoice_data->weight; ?>" name="weight_qty" placeholder="Enter weight here"  required>
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="rate_qty" value="<?php echo $invoice_data->rate; ?>" onblur="checkInvoice()" name="rate_qty" placeholder="Enter Rate here"  required>
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="item_total_amount" value="<?php echo $invoice_data->total_invoice; ?>" name="item_total_amount" value="0" disabled>
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="detail_textarea" name="detail_textarea" rows="5" cols="70"><?php echo $invoice_data->detail_box; ?></textarea>
                                                </div>
                                            ...
                                            <div class="mt-3">
                                                ...
                                                if ($invoice_data->invoice_type == 1) {
                                                    ...
                                                    ?>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;<b>Entry Type:</b>&nbsp;&nbsp;
                                                    <input type="radio" checked id="entry_type" name="entry_type" value="1" onclick="checkEntry()" checked="">&nbsp;&nbsp;Buyer&nbsp;&nbsp;
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <input type="radio" checked id="entry_type" name="entry_type" value="2" onclick="checkEntry()"> &nbsp;&nbsp;Seller

                                                <?php } if ($invoice_data->pending_value == 1) {
                                                    $checked_value = 'checked';
                                                } else {
                                                    $checked_value = '';
                                                } ?>
                                                <b class="float-left">Pending:&nbsp;&nbsp;<input  type="checkbox" <?php echo $checked_value; ?> id="pending_box" name="pending_box" value="1" onclick="checkEntry()"></b>
                                            </div>
                                            <br>
                                            <div id="error"></div>
                                            <button class="btn btn-primary" type="button" id="submit_button" name="submit_button">Update Invoice </button>
                                        </form>
        ...
        <script type="text/javascript">
                                                    ...
                                                    $(document).ready(function () {
                                                        ...
                                                        $("#submit_button").click(function (event) {
                                                            ...
                                                            var invoice_hashval = document.getElementById('invoice_hashval').value;
                                                            ...
                                                            if (date == '') {
                                                                ...
                                                                $.ajax({
                                                                    //alert(email);
                                                                    url: "<?php echo base_url() . 'invoices/update_invoice_entry'; ?>",
                                                                    data: {"entry_type": invoice_entry_type,
                                                                        "hashval": invoice_hashval,
                                                                        "date": date,
